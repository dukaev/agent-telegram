...
export const appProductReadiness: ToolcraftProductReadiness = {
  mode: "product",
  productName: "Duck Agent Cards",
  productSummary:
    "A four-variant Telegram AI-agent promo-card editor using the supplied duck image.",
  requestedBehavior:
    "Provide Hero, Thinking, Chat, and Cards layouts with editable source media, copy, brand colors, background behavior, and PNG/JPG export.",
};

export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  {
    automated: true,
    automatedTestName: "layout variants map to distinct product output",
    browser: true,
    browserTestName: "browser: all four layout variants change product output",
    componentType: "segmented",
    evidence: "product-output",
    expectedObservable:
      "Hero, Thinking, Chat, and Cards each render a distinct card composition around the supplied duck photo.",
    fixture: "Default img.jpg and default card copy",
    id: "card.variant",
    kind: "control",
    optionCoverage: ["hero", "thinking", "chat", "cards"],
    target: "card.variant",
    userAction: "Click every visible Variant segment and compare the rendered card composition.",
  },
  {
    automated: true,
    automatedTestName: "source media lifecycle reaches preview and export",
    browser: true,
    browserTestName: "browser: source photo upload transforms clear and reset reach output",
    componentType: "fileDrop",
    evidence: "media-lifecycle",
    expectedObservable:
      "The predefined attached img.jpg renders in preview/export, upload replaces it, rotate and flip consume runtime mediaAssets transform metadata, clear removes it to a neutral canvas, and global or section reset restores the default asset.",
    fixture: "Default img.jpg plus a contrasting uploaded SVG image",
    id: "source.image",
    kind: "control",
    target: "source.image",
    userAction:
      "Upload/import a photo, rotate 90 degrees, Flip H, Flip V, verify preview/export transforms, clear/remove the uploaded and predefined media, then use section or global Reset to restore default img.jpg.",
  },
  {
    automated: true,
    automatedTestName: "image scale changes live source crop",
    browser: true,
    browserTestName: "browser: image scale drag changes product output live",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable:
      "Dragging Image scale changes the visible duck crop during the pointer drag without changing canvas dimensions.",
    fixture: "Hero variant at 80%, 104%, and 140% image scale",
    id: "source.scale",
    kind: "control",
    target: "source.scale",
    userAction: "Drag the Image scale slider thumb while observing the source crop.",
  },
  {
    automated: true,
    automatedTestName: "headline text reaches every layout",
    browser: true,
    browserTestName: "browser: headline edits product text",
    componentType: "text",
    evidence: "product-output",
    expectedObservable: "Typing a new headline updates the visible product headline in the active layout.",
    fixture: "Headline fixture: Утёнок уже придумал",
    id: "copy.headline",
    kind: "control",
    target: "copy.headline",
    userAction: "Select the Headline field and type replacement copy.",
  },
  {
    automated: true,
    automatedTestName: "caption text reaches product output",
    browser: true,
    browserTestName: "browser: caption edits product text",
    componentType: "text",
    evidence: "product-output",
    expectedObservable: "Typing a new caption updates the visible supporting product text.",
    fixture: "Caption fixture: Помощник, который не теряет контекст",
    id: "copy.caption",
    kind: "control",
    target: "copy.caption",
    userAction: "Select the Caption field and type replacement copy.",
  },
  {
    automated: true,
    automatedTestName: "telegram handle reaches product output",
    browser: true,
    browserTestName: "browser: telegram handle edits product text",
    componentType: "text",
    evidence: "product-output",
    expectedObservable: "Typing a new Telegram handle updates the visible handle in the card.",
    fixture: "Telegram fixture: @smart_duck",
    id: "copy.handle",
    kind: "control",
    target: "copy.handle",
    userAction: "Select the Telegram field and type a replacement handle.",
  },
  {
    automated: true,
    automatedTestName: "accent color reaches product composition",
    browser: true,
    browserTestName: "browser: accent color changes rendered card",
    componentType: "color",
    evidence: "rendered-pixels",
    expectedObservable: "Changing Accent recolors the Telegram mark, CTA, bubbles, and feature-card accents.",
    fixture: "Accent changes from #229ED9 to #7C3AED",
    id: "appearance.accent",
    kind: "control",
    target: "appearance.accent",
    userAction: "Open Accent and enter a contrasting hex color.",
  },
  {
    automated: true,
    automatedTestName: "include background controls preview and export alpha",
    browser: true,
    browserTestName: "browser: include background toggles preview and png alpha",
    componentType: "switch",
    evidence: "rendered-pixels",
    expectedObservable:
      "Turning Include off hides the live preview product background and exports transparent PNG alpha; video output would keep the background if video export were enabled.",
    fixture: "Hero layout with Include on and off",
    id: "export.includeBackground",
    kind: "control",
    target: "export.includeBackground",
    userAction: "Toggle Include off, inspect preview background, export PNG alpha, then toggle it on.",
  },
  {
    automated: true,
    automatedTestName: "background color reaches preview and export",
    browser: true,
    browserTestName: "browser: background color changes preview and exported pixels",
    componentType: "color",
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing the Background color changes the live product background and included export pixels.",
    fixture: "Background changes from #F4F1E8 to #DFF5FF",
    id: "appearance.background",
    kind: "control",
    target: "appearance.background",
    userAction: "Change the unlabeled Background color while Include is on, then export the card.",
  },
  {
    automated: true,
    automatedTestName: "image format controls exported mime and extension",
    browser: true,
    browserTestName: "browser: png and jpg formats produce matching image bytes",
    componentType: "select",
    evidence: "exported-bytes",
    expectedObservable: "PNG and JPG selections produce matching MIME bytes and filename extensions.",
    fixture: "Default Hero card exported as PNG and JPG",
    id: "export.image.format",
    kind: "control",
    optionCoverage: ["png", "jpg"],
    target: "export.image.format",
    userAction: "Select PNG and JPG in Format and export each result.",
  },
  {
    automated: true,
    automatedTestName: "image resolution controls real exported dimensions",
    browser: true,
    browserTestName: "browser: 2k 4k and 8k resolutions change decoded dimensions",
    componentType: "select",
    evidence: "exported-bytes",
    expectedObservable:
      "2K, 4K, and 8K produce images with real 2048px, 4096px, and 8192px long edges while preserving the canvas aspect ratio.",
    fixture: "Default 1920x1080 card exported at 2K, 4K, and 8K",
    id: "export.image.resolution",
    kind: "control",
    optionCoverage: ["2k", "4k", "8k"],
    target: "export.image.resolution",
    userAction: "Select 2K, 4K, and 8K in Resolution, export, and decode each image.",
  },
  {
    actionCoverage: ["export.png"],
    automated: true,
    automatedTestName: "export action returns real async image bytes",
    browser: true,
    browserTestName: "browser: export image reports progress and downloads output",
    componentType: "panelActions",
    evidence: "exported-bytes",
    expectedObservable:
      "Export image returns a real Promise, shows and advances the sticky footer progress indicator, downloads non-empty selected-format bytes at selected resolution with current background behavior, then hides progress after settling.",
    fixture: "Cards variant with custom copy, accent, background, format, and resolution",
    id: "actions.output",
    kind: "control",
    target: "actions.output",
    userAction: "Click Export image and observe pending progress until the download completes.",
  },
  {
    automated: true,
    automatedTestName: "custom renderer exposes semantic product layers",
    browser: true,
    browserTestName: "browser: renderer shows background and foreground product layers",
    componentType: "DOM product renderer",
    evidence: "product-output",
    expectedObservable:
      "The canvas contains a backgroundLayer and productForegroundLayer with image, copy, and variant-specific geometry only.",
    fixture: "Default Hero card",
    id: "renderer.card",
    kind: "runtime",
    userAction: "Open the app and inspect the visible product output layers.",
  },
];

export const starterControlSectionInventory: readonly ToolcraftControlSectionInventoryEntry[] = [
  {
    entity: "Card composition",
    groupingReason: "The section selects one of the four requested visual compositions.",
    targets: ["card.variant"],
    title: "Layout",
  },
  {
    entity: "Source media attachment",
    groupingReason: "The runtime media section owns the attached image lifecycle and transform actions.",
    targets: ["source.image"],
    title: "Photo",
  },
  {
    entity: "Source crop",
    groupingReason: "The app-authored source section controls how the attached image is cropped.",
    targets: ["source.scale"],
    title: "Source",
  },
  {
    entity: "Promo copy",
    groupingReason: "Headline, caption, and handle are the three semantic text roles shared by every variant.",
    targets: ["copy.headline", "copy.caption", "copy.handle"],
    title: "Message",
  },
  {
    entity: "Brand accent",
    groupingReason: "The accent color controls the shared Telegram and emphasis role.",
    targets: ["appearance.accent"],
    title: "Brand",
  },
  {
    entity: "Product background",
    groupingReason: "Include state and background color jointly control preview and exported background behavior.",
    targets: ["export.includeBackground", "appearance.background"],
    title: "Background",
  },
  {
    workflowStage: "Image delivery",
    groupingReason: "Format and resolution jointly configure final image encoding and dimensions.",
